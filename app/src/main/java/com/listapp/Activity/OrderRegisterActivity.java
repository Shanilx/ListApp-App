...
public class OrderRegisterActivity extends AppCompatActivity implements ExpandableListView.OnGroupClickListener, ExpandableListView.OnChildClickListener, OnClickListener {
...
//        FullScreenSupporterSearch.assistActivity(MedicineSearchActivity.this);
        ...
        setUpView();
        whichScreen = 1;
        getSupportFragmentManager().beginTransaction().replace(R.id.homeActivityFragment, new OrderlistFragment(this), "").addToBackStack("").commit();
        heading.setVisibility(View.VISIBLE);
        heading.setText("ORDER");
    ...
    protected void onResume() {
        ...
        if (!PreferenceConnector.readString(OrderRegisterActivity.this, "gotoNotification", "").equals("")) {
    ...
    private void setUpView() {
        ...
        search.setHintTextColor(ContextCompat.getColor(OrderRegisterActivity.this, R.color.dummyTextLightBlack));
        ...
        drawerIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                AppUtil.hideKeyBoard(OrderRegisterActivity.this);
        ...
        navigationListAdapter = new NavigationListAdapter(OrderRegisterActivity.this, listDataHeader, listDataChild);
...
//It retrieves the latest version by scraping the content of current version from play store at runtime
    ...
    private void getProfileDetail() {
        ...
        final ProgressDialog progressDialog = AppUtil.createProgressDialog(OrderRegisterActivity.this);
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (getProfileResponse != null) {
                    ...
                    if (getProfileResponse.getError().equals("0")) {
                        PreferenceConnector.writeBoolean(OrderRegisterActivity.this, "firstTimeGetProfile", true);
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.FULL_NAME, getProfileResponse.getData().getRetailerName());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.USER_ID, getProfileResponse.getData().getUserId());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.EMAIl, getProfileResponse.getData().getEmail());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.AREA, getProfileResponse.getData().getArea());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.ADDRESS, getProfileResponse.getData().getAddress());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.CITY, getProfileResponse.getData().getCity());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.STATE, getProfileResponse.getData().getState());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.SHOP_NAME, getProfileResponse.getData().getShopName());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.CONTACT_NUMBER, getProfileResponse.getData().getContactNumber());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.TIN_NUMBER, getProfileResponse.getData().getTinNumber());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.ESTD_YEAR, getProfileResponse.getData().getEstdYear());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.DL_NUMBER, getProfileResponse.getData().getDrugLicNo());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.CITY_ID, getProfileResponse.getData().getCityId());
                        PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.STATE_ID, getProfileResponse.getData().getStateId());
                        userName.setText(PreferenceConnector.readString(OrderRegisterActivity.this, PreferenceConnector.SHOP_NAME, ""));
                        String add = PreferenceConnector.readString(OrderRegisterActivity.this, PreferenceConnector.ADDRESS, "");
                        address.setText(add);
                        OrderRegisterActivity.this.mobileNumber.setText(PreferenceConnector.readString(OrderRegisterActivity.this, PreferenceConnector.MOBILE_NUMBER, ""));
                        ...
                        if (list != null) {
                            ...
                            PreferenceConnector.writeString(OrderRegisterActivity.this, PreferenceConnector.CONTACT_PERSON, strContactPerson.toString());
                        }
                        setData();
                    } else {
                        if (getProfileResponse.getMessage().equalsIgnoreCase("Your session has been expired")) {
                            AppUtil.sessionLogout(getProfileResponse.getMessage(), OrderRegisterActivity.this);
                        } else if (getProfileResponse.getMessage().equalsIgnoreCase("Your account has been deactivated by administrator"))
                            AppUtil.sessionLogout(getProfileResponse.getMessage(), OrderRegisterActivity.this);
                        else
                            AppUtil.showAlert(getProfileResponse.getMessage(), OrderRegisterActivity.this);
                    }
                } else
                    AppUtil.showAlert(getString(R.string.serverError), OrderRegisterActivity.this);
            }
    ...
    public AutoCompleteTextView getToolbarSearch() {
        return findViewById(R.id.toolbarSearch);
    }
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        switch (groupPosition) {
            ...
            case 9:
                ...
                AppUtil.hideKeyBoard(this);
                clearFragmentStack();
                AppUtil.userLogout(OrderRegisterActivity.this);
                break;
        }
